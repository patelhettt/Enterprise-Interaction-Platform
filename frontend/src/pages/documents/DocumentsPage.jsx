...
const S = `
  ...
  .dp-root {
    min-height: 100vh;
    background: radial-gradient(circle at 50% 0%, #0f0d23ff 0%, #010102ff 40%, #120e18ff 100%);
  ...
  .dp-toolbar { padding: 0 48px 24px; display: flex; align-items: center; justify-content: space-between; gap: 12px; position: relative; z-index: 10; }
